<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <span class="btn bg-primary btn-icon-split" style="cursor: default">
        <span class="text text-white shadow-sm"> Jumlah Semua RPP</span>
...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <a href="{{ route('supervisor.rpp.menilai') }}" style="text-decoration: none">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-secondary shadow h-100 py-2">
            <div class="card-body">
                <a href="{{ route('supervisor.rpp.belum-disetujui') }}" style="text-decoration: none">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <a href="{{ route('supervisor.rpp.disetujui') }}" style="text-decoration: none">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-danger shadow h-100 py-2">
            <div class="card-body">
                <a href="{{ route('supervisor.rpp.tidak-disetujui') }}" style="text-decoration: none">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Pie Chart RPP</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                <div class="chart-pie pt-4 pb-2">
                    <canvas id="rppPieChart"></canvas>
                </div>
                <div class="mt-4 text-center small">
                    ...
                    <span class="mr-2">
                        <i class="fas fa-circle text-secondary"></i> Menunggu Persetujuan
                    </span>
                    <span class="mr-2">
...
<script>
    ...
    // Pie Chart Example
    var ctx = document.getElementById("rppPieChart");
    var myPieChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels: ["Disetujui", "Tidak Disetujui", "Menunggu Persetujuan", 'Belum Dinilai'],
            datasets: [{
                data: [{{$disetujui}}, {{$tak_disetujui}}, {{$belum_disetujui}}, {{$belum_dinilai}}],
                backgroundColor: ['#1cc88a', '#e74a3b', '#858796', '#36b9cc'],
                hoverBackgroundColor: ['#17a673', '#e02d1b', '#717384', '#2c9faf'],
