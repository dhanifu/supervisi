...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">RPP Yang Disetujui</h1>
</div>
     ...
     <div class="col-lg-12">
        ...
        <div class="card mb-4 shadow h-100">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Data RPP yang disetujui
                    ...
                    <table class="table table-bordered" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $r->nilai }}</td>
                                <td align="center">
                                    <span class="text-success" title="Disetujui">
