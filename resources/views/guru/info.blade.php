...
@section('title', 'Guru - RPP yang '.$title)
@section('active-guru-upload', 'active')

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><a href="{{route('guru.home')}}">Dashboard</a> / RPP yang {{$title}}</h1>
</div>
        ...
        <div class="card mb-4 shadow h-100">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Data RPP
                    <button class="btn btn-sm btn-primary shadow-sm float-right" onclick="document.location.href='{{route('guru.home')}}'">
